...
UPDATE system_sub_modules SET is_active=0 WHERE id IN (2,3,4,12,13);
...
UPDATE system_sub_modules SET is_active=0 WHERE id IN (112,113);
...
(2,3,4,12,13,25,28,29,35,37,38,39,40,44,46,47,48,49,50,51,52,53,54,56,57,58,61,62,63,65,66,67,68,69,72,76,81,91,95,97,99,100,107,108,109,110,112,113,116,117,121,122,123,124,125,126);