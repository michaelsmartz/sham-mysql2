...
CHANGE COLUMN `Priority` `priority` TINYINT(3) UNSIGNED NOT NULL ,
...
CHANGE COLUMN `Id` `id` INT(11) NOT NULL AUTO_INCREMENT ,
CHANGE COLUMN `Description` `description` VARCHAR(100) NOT NULL ,
CHANGE COLUMN `Active` `ia_active` TINYINT(1) NOT NULL DEFAULT '1' ,
ADD COLUMN `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP AFTER `ia_active`,
ADD COLUMN `updated_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP AFTER `created_at`,
ADD COLUMN `deleted_at` DATETIME NULL AFTER `updated_at`;
