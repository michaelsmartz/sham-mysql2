...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="#">Tax Status</a></li>
    ...
    <div class="flex-wrapper">
        <div id="table-container">
            ...
            @if(count($taxStatuses) == 0)
                <h4 class="text-center">Its a bit empty here. You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new tax status</h4>
            @else
                        ...
                        <tr id="tr{{$taxStatus->id}}">
                            ...
                            <td data-html2canvas-ignore="true">
                                <div class="btn-group btn-group-xs" role="group">
                                    <a href="#light-modal" data-wenk="Edit" class="b-n b-n-r bg-transparent item-edit" onclick="editForm('{{$taxStatus->id}}', event)">
                                        <i class="glyphicon glyphicon-edit text-primary"></i>
                                    </a>
                                    <button class="b-n b-n-r bg-transparent item-remove" data-wenk="Remove" onclick="deleteForm('{{$taxStatus->id}}')">
            ...
            @component('partials.index', ['routeName'=> 'tax_statuses.destroy'])
            @endcomponent
        </div>
    </div>
@endsection