...
@section('subtitle','Ethnic Group drop-down values for employees')
@section('content')
    <br>
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="#">Ethnic Group</a></li>
    ...
    <div class="flex-wrapper">
        <div id="table-container">
            ...
            @if(count($ethnicGroups) == 0)
                <h4 class="text-center">Its a bit empty here. You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new ethnic group</h4>
            @else
                <table id="new-table" data-toggle="table">
                    ...
                    <tbody>
                        ...
                        <tr id="tr{{$ethnicGroup->id}}">
                                                        <td>{{ $ethnicGroup->description }}</td>

                            <td data-html2canvas-ignore="true">
                                <div class="btn-group btn-group-xs" role="group">
                                    <a href="#light-modal" data-wenk="Edit" class="b-n b-n-r bg-transparent item-edit" onclick="editForm('{{$ethnicGroup->id}}', event)">
                                        <i class="glyphicon glyphicon-edit text-primary"></i>
                                    </a>
                                    <button class="b-n b-n-r bg-transparent item-remove" data-wenk="Remove" onclick="deleteForm('{{$ethnicGroup->id}}')">
            ...
            @component('partials.index', ['routeName'=> 'ethnic_groups.destroy'])
            @endcomponent
        </div>
    </div>
@endsection