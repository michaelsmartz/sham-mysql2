...
<div class="form-group col-xs-12 {{ $errors->has('description') ? 'has-error' : '' }}">
    ...
    <input class="form-control" name="description" type="text" id="description" value="{{ old('description', optional($language)->description) }}" minlength="5" maxlength="50" required="true" placeholder="Enter description">
