...
@section('content')
    <div class="flex-wrapper">
        <div id="table-container">
            ...
            @if(count($absenceTypes) == 0)
                <h4 class="text-center">Its a bit empty here. You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new absence type</h4>
            @else
            ...
            @component('partials.index', ['routeName'=> 'absenceTypes.destroy'])
            @endcomponent
        </div>
    </div>
@endsection