...
@foreach($evaluationDetails->assessors as $assessor)
    <div class="row" style=" margin-top: -12px;">
        ...
        <div class="col-md-4" data-id="{{$assessor->id}}" data-evaluationid='{{$assessor->evaluation_id}}'  data-assessorid='{{$assessor->employee_id}}'>
            ...
            <button type="button" title="Score" class="b-n b-n-r bg-transparent item-assessoredit tooltips" onclick="assessorEditForm($(this).closest('div').data('id'), event)"><i class="glyphicon glyphicon-hand-right text-bootstrap-primary"></i></button>
