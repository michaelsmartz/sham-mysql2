...
<div class="form-group col-xs-12 {{ $errors->has('tag') ? 'has-error' : '' }}">
...
<div class="form-group col-xs-12 {{ $errors->has('serial_no') ? 'has-error' : '' }}">
...
<div class="form-group col-xs-12 {{ $errors->has('purchase_price') ? 'has-error' : '' }}">
...
<div class="form-group col-xs-12 {{ $errors->has('po_number') ? 'has-error' : '' }}">
...
<div class="form-group col-xs-12 {{ $errors->has('warranty_expiry_date') ? 'has-error' : '' }}">
...
<div class="form-group col-xs-12 {{ $errors->has('asset_condition_id') ? 'has-error' : '' }}">
