...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="#">Immigration Status</a></li>
    ...
    <div class="flex-wrapper">
        <div id="table-container">
            @if(count($immigrationStatuses) > 0)
            ...
            @if(count($immigrationStatuses) == 0)
                <h4 class="text-center">Its a bit empty here. You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new immigration status</h4>
            @else
                        ...
                        <tr id="tr{{$immigrationStatus->id}}">
                            ...
                            <td data-html2canvas-ignore="true">
                                <div class="btn-group btn-group-xs" role="group">
                                    <a href="#light-modal" data-wenk="Edit" class="b-n b-n-r bg-transparent item-edit" onclick="editForm('{{$immigrationStatus->id}}', event)">
                                        <i class="glyphicon glyphicon-edit text-primary"></i>
                                    </a>
                                    <button class="b-n b-n-r bg-transparent item-remove" data-wenk="Remove" onclick="deleteForm('{{$immigrationStatus->id}}')">
                ...
                <nav>
                    {!! $immigrationStatuses->render() !!}
                </nav>
            @endif
            </div>
            @component('partials.index', ['routeName'=> 'immigration_statuses.destroy'])
            @endcomponent
        </div>
    </div>
@endsection