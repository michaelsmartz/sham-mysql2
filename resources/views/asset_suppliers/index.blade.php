                    ...
                    <ul style="margin-left:0;padding-left:0" class="list-unstyled">
                        <li>
                            ...
                            <div class="table-search-form">
                                ...
                                <div class="search-option">
                                    ...
                                    <a href="{{route('asset_suppliers.index')}}" role="button" data-wenk="Reset all Criteria & reload the list">
                        ...
                        <li>
                            ...
                            <ul class="search-column-list">
                                ...
                                <li data-filter-column="telephone">By Telephone</li>
                                <li data-filter-column="email_address">By Email Address</li>
        ...
        <div id="table-container">
            ...
            @if(count($assetSuppliers) == 0)
                <h4 class="text-center">Its a bit empty here.
                    @if($allowedActions->contains('Create'))
                        You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new asset supplier
                    @endif
                </h4>
