...
@section('subtitle','Employee Status drop-down values for employees')
@section('content')
    <br>
    ...
    <div class="flex-wrapper">
        <div id="table-container">
            ...
            @if(count($employeeStatuses) == 0)
                ...
                @if($allowedActions->contains('Create'))
                        You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new employee status
                @endif
                </h4>
