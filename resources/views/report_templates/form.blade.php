...
<div class="form-group col-xs-12 {{ $errors->has('source') ? 'has-error' : '' }}">
    <label for="source">Source</label>
        <input class="form-control" name="source" type="text" id="source" value="{{ old('source', optional($reportTemplate)->source) }}" minlength="1" placeholder="Enter source">
...
<div class="form-group col-xs-12 {{ $errors->has('system_module_id') ? 'has-error' : '' }}">
    <label for="system_module_id">System Module</label>
        <select class="form-control" id="system_module_id" name="system_module_id" required="true">
