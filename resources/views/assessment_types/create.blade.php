...
@section('content')
    <div class="box box-primary">
        <div class="box-body">
            <form method="POST" action="{{ route('assessment_types.store') }}" accept-charset="UTF-8" id="create_assessment_type_form" name="create_assessment_type_form" class="form-horizontal">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-12">
