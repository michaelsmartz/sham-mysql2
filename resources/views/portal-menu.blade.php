    ...
    <li class="has-sub">
        ...
        <ul class="sub-menu">
            ...
            @if (isset($allowedmodules[App\SystemModule::CONST_CENTRAL_HR][App\SystemSubModule::CONST_ASSETS_MANAGEMENT]))
                <li class="{{ (Request::is('asset_allocations/*') || Request::is('asset_allocations') || Request::is('assets') || Request::is('assets/*') || Request::is('asset_suppliers/*') || Request::is('asset_suppliers') ? 'active' : '') }}"> <a href="{{URL::to('/')}}/asset_groups">Assets Allocation</a></li>
            @endif
    ...
    <li class="has-sub" >
        ...
        <ul class="sub-menu">
            ...
            @if (isset($allowedmodules[App\SystemModule::CONST_EMPLOYEE_PORTAL][App\SystemSubModule::CONST_MY_LEAVES]))
                <li class="{{ (Request::is('my-leaves') || Request::is('my-leaves/filter') || Request::is('my-leaves/filter/calendar') || Request::is('my-leaves-history') || Request::is('my-leaves-pending-request') ? 'active' : '') }}"> <a href="{{URL::to('/')}}/my-leaves">Leaves</a></li>
            @endif
    ...
    <li class="has-sub">
        ...
        <ul class="sub-menu">
            ...
            @if (isset($allowedmodules[App\SystemModule::CONST_QUALITY_ASSURANCE][App\SystemSubModule::CONST_ASSESSMENT_CATEGORIES]))
                <li><a href="{{URL::to('/')}}/assessment_categories">Assessment Categories</a></li>
            @endif
    ...
    <li class="has-sub">
        ...
        <ul class="sub-menu">
            @if (isset($allowedmodules[App\SystemModule::CONST_LEAVE][App\SystemSubModule::CONST_ABSENCE_TYPES]))
                <li class="{{ (Request::is('absence_types/*') || Request::is('absence_types') ? 'active' : '') }}"> <a href="{{URL::to('/')}}/absence_types">Leave Types</a></li>
            @endif
