...
@section('content')
    <div class="box box-primary">
        <div class="box-body">
            <form method="POST" action="{{ route('employeeExportProcessors.download') }}" accept-charset="UTF-8" id="create_employee_processor_form" name="create_employee_processor_form" class="form-horizontal">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
