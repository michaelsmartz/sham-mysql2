...
@section('content')
    <div class="flex-wrapper">
        <div id="table-container">
            ...
            @if(count($courseTrainingSessions) == 0)
                <h4 class="text-center">Its a bit empty here. You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new course training session</h4>
            @else
