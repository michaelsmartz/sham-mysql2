        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-heading" style="border-bottom: 1px solid #ddd;">
                    <span class="glyphicon glyphicon-lock"></span> @lang('auth.candidateLogin')
                </div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('candidate.auth.loginCandidate') }}" autocomplete="off">
                        {{ csrf_field() }}
