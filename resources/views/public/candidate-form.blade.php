            ...
            <div id="candidate-details" class="container-fluid panel">
                <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-personal" data-toggle="tab" href="javascript:void(0);" aria-selected="true"><i class="glyphicon glyphicon-user"></i> Personal Information</a>
