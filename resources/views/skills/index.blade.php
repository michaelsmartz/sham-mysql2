...
@section('subtitle','Skill drop-down values for employees')
@section('content')
    <br>
    ...
    <div class="flex-wrapper">
        <div id="table-container">
            ...
            @if(count($skills) == 0)
                <h4 class="text-center">Its a bit empty here. You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new skill</h4>
            @else
                        ...
                        <tr id="tr{{$skill->id}}">
                            ...
                            <td data-html2canvas-ignore="true">
                                <div class="btn-group btn-group-xs" role="group">
                                    <a href="#light-modal" data-wenk="Edit" class="b-n b-n-r bg-transparent item-edit" onclick="editForm('{{$skill->id}}', event)">
                                        <i class="glyphicon glyphicon-edit text-primary"></i>
                                    </a>
                                    <button class="b-n b-n-r bg-transparent item-remove" data-wenk="Remove" onclick="deleteForm('{{$skill->id}}')">
            ...
            @component('partials.index', ['routeName'=> 'skills.destroy'])
            @endcomponent
        </div>
    </div>
@endsection