...
@section('content')
    <section id="survey">
                ...
                @foreach($surveys as $survey)
                    <div class="col-sm-12 col-xs-12 col-md-4 col-lg-4">
                        <div class="thumbnail">
                            ...
                            <a class="btn btn-primary col-xs-12 item-edit" onclick="showForm('{{ $survey->id }}', event)" role="button">Complete this survey</a>
        ...
        @component('partials.index', ['routeName'=> 'my-surveys.destroy', 'fullPageShow'=>true])
        @endcomponent
    </section>
@endsection
