...
@section('subtitle','Time Period drop-down values for employees')
@section('content')
    <br>
    ...
    <div class="flex-wrapper">
        <div id="table-container">
            ...
            @if(count($timePeriods) == 0)
                ...
                @if($allowedActions->contains('Create'))
                    You may click <a href="javascript:;" class="text-primary item-create">here</a> to add a new time period
                @endif
                </h4>
