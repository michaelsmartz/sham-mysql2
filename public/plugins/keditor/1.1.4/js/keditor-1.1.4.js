    ...
    KEditor.prototype = {
        ...
        renderSnippets: function (resp) {
            ...
            $('<div />').html(resp).find('> div').each(function (i) {
                ...
                var snippetHtml = '';
                var categories = snippet.attr('data-categories') || '';
                var user = snippet.attr('data-user') || ' ';
                ...
                snippetHtml += '   <img class="keditor-snippet-preview' + user + '" src="' + previewUrl + '" />';
                snippetHtml += '</section>';
        ...
        convertToComponent: function (contentArea, container, target, isExisting) {
            ...
            //console.log('convertToComponent');
			//console.log(contentArea); console.log(container); console.log(target); console.log(isExisting);
            var self = this;
            var isSection = target.is('section');
            var component;
        ...
        initKEditorClicks: function () {
            ...
            body.on('click', '.btn-container-delete', function (e) {
                ...
                if (confirm('Are you sure that you want to delete this page? This action cannot be undone!')) {
                    var container = btn.closest('.keditor-container');
