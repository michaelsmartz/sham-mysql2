  ...
  var Formbuilder = function(opts){
    ...
    (function(engine){
      ...
      targets.on('click', '.frmb-add-choice', function(e){
        ...
        //$.event.trigger('fb-element-choice-added', [parent, engine._model[id]]);
      ...
      targets.on('click', '.frmb-remove', function(e){
        ...
        //$.event.trigger('fb-element-removed', [parent, engine._model[id].type]);
      ...
      targets.on('click', '.frmb-choice-remove', function(e){
        ...
        var id = parent.attr('id');
        //$.event.trigger('fb-element-choice-removed', [elem.parents('.frmb-choices:eq(0)').attr('id'), engine._model[id]]);
        engine.removeModel( id );
        parent.remove();
      ...
      targets.on('change', 'input[type=checkbox]', function(e){
        ...
        //$.event.trigger('fb-element-checked', [elem.parents('.frmb-choices:eq(0)'), engine._model[id]]);
