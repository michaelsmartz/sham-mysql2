...
class SystemSubModule extends Model
{
	...
	const CONST_EMPLOYEE_ATTACHMENT_TYPES = 114;
	const CONST_QA_INSTANCES= 115;
	const CONST_PRODUCT_CATEGORIES= 116;
	const CONST_PUBLIC_HOLIDAYS = 117;
	...
	const CONST_EVENTS = 125;
	const CONST_LINK_TYPES = 126;
	const CONST_TODO_ITEMS = 127;
	const CONST_TIMEPERIODS = 128;
	const CONST_DISCIPLINARYDECISIONS = 129;
