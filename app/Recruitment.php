...
class Recruitment extends Model
{
    ...
    */
    ...
    {
        return $this->belongsToMany(Interview::class, 'candidate_interview_recruitment','recruitment_id','interview_id')->withPivot('id','reasons','schedule_at','results','location','status');
    }
