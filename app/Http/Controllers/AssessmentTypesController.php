...
class AssessmentTypesController extends CustomController
{
    ...
    {
        $this->contextObj = new AssessmentTypes();
        $this->baseViewPath = 'assessment_types';
        $this->baseFlash = 'Assessment Types details ';
    }
    ...
    {
        $assessmentTypesObjects = $this->contextObj::filtered()->paginate(10);
        return view($this->baseViewPath .'.index', compact('assessmentTypesObjects'));
    }

    /**
     * Store a new assessment types in the storage.
     *
    ...
    /**
     * Remove the specified assessment types from the storage.
     *
     * @param  int $id
     *
     * @return Illuminate\Http\RedirectResponse | Illuminate\Routing\Redirector
