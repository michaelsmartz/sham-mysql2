...
class AssetConditionsController extends CustomController
{
    ...
    public function index()
    {
        ...
        $allowedActions = Helper::getAllowedActions(SystemSubModule::CONST_ASSET_CONDITION);

        // handle empty result bug
        if (Input::has('page') && $assetConditions->isEmpty()) {
            return redirect()->route($this->baseViewPath .'.index');
        }        
        return view($this->baseViewPath .'.index', compact('assetConditions','allowedActions'));
    }
