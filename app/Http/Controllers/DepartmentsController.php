...
class DepartmentsController extends CustomController
{
    /**
    ...
    {
        $this->contextObj = new Department();
        $this->baseViewPath = 'departments';
        $this->baseFlash = 'Department details ';
    }
    ...
    public function index()
    {
        ...
        $allowedActions = Helper::getAllowedActions(SystemSubModule::CONST_DEPARTMENT);
