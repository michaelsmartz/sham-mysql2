...
class OffersController extends CustomController
{
    /**
    ...
    {
        $this->contextObj = new Offer();
        $this->baseViewPath = 'offers';
        $this->baseFlash = 'Offer details ';
    }
    ...
    {
        $offers = $this->contextObj::filtered()->paginate(10);
        return view($this->baseViewPath .'.index', compact('offers'));
    }
    ...
    {
        $id = Route::current()->parameter('offer');
