...
class CompaniesController extends CustomController
{
    /**
    ...
    {
        $this->contextObj = new Company();
        $this->baseViewPath = 'companies';
        $this->baseFlash = 'Company details ';
    }
    ...
    {
        $data = null;
        $id = Route::current()->parameter('company');
